...
from resnet_model_center_loss import ResNetModel
...
tf.app.flags.DEFINE_string('weights_path', '/home/bonnie/companydata/models/ResNet-L101.npy',
                           'Model path')
# tf.app.flags.DEFINE_string('weights_path', '/home/bonnie/companydata/mars/models/resnet_20180411_160634/checkpoint/model.ckpt',
#                            'Model path')
